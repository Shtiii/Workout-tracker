 ...
 */
export default function HistoryView({ allWorkouts, onDeleteWorkout }: HistoryViewProps) {
  const sortedWorkouts = [...allWorkouts].sort((a, b) => b.completedAt.getTime() - a.completedAt.getTime());
                ...
                secondary={
                  <Box sx={{ mt: 1 }}>
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                      Duration: {Math.round((workout.endTime.getTime() - workout.startTime.getTime()) / (1000 * 60))} min |
